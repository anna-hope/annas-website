...
I don't know what I blogged about in that first iteration, because that website (and its *really cool* domain name)
...
in a black hood, or something else equally *badass,* complete with a message that I've been pwned
...
which I later replaced with (probably very unidiomatic and very, very ugly) vanilla JS. Being Flask, 
...
misshapen screws, and a rusty multitool," so at least I was self-aware.
...
until I let life get in the way.

One day, it went down, and I didn't bother to start it up again.
...
field on platforms like GitHub and elsewhere, and thought it might help me find a job,
...
So, here we are. I have a blog again, again. It's built with [Zola](https://www.getzola.org/) 
...
I still plan on adding a Russian version because I do have some ideas for blog posts in Russian — 
